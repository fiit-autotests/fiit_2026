...
public class UserManagerTests
{
    ...
    {
        var exception = Assert.Throws<InvalidUserException>(() => _userManager.CreateNewUser(_newInvalidUser));
        
        Assert.That(exception!.Message, Is.EqualTo("Invalid user"));
    ...
    {
        var exception = Assert.Throws<InvalidUserException>(() => _userManager.CreateNewUser(_user1));
    ...
    {
        var exception = Assert.Throws<InvalidOperationException>(() => _userManager.DeleteUser(_newInvalidUser.Email));
