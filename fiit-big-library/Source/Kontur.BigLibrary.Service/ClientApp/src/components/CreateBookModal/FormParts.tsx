        ...
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                <input
                    ...
                    required
                />
                <div className="invalid-feedback" id='bookName-invalid-feedback'>
        ...
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                <input
                    ...
                    required
                />
                <div className="invalid-feedback" id='bookAuthor-invalid-feedback'>
                    {"Поле не может быть пустым и быть длиннее 20 символов"}
                </div>
            </div>
        </div>
    ...
    <div className="row">
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                <textarea
                    ...
                    onChange={handleInputChange}
                />
                <div className="invalid-feedback" id='bookDescription-invalid-feedback'>
                    {"Поле не может быть пустым и быть длиннее 20 символов"}
                </div>
            </div>
        </div>
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                <div className="invalid-feedback" id='bookRubricId-invalid-feedback'>
                    {
                        "Выберите рубрику"
                    }
                </div>
        ...
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                />
                <div className="invalid-feedback" id='bookImageFile-invalid-feedback'>
                    {
        ...
        <div className="col-md-10 mx-auto">
            <div className="form-group">
                ...
                <input
                    ...
                    onChange={handleInputChange}
                />
                <div className="invalid-feedback"  id='bookPrice-invalid-feedback'>{"Цена не может быть пустой"}</div>
            </div>
        </div>
    </div>
);